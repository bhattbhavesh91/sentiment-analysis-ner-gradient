<h1>Effortless NLP with Open-Source LLMs : Sentiment Analysis, Entity Extraction &amp; Summarization</h1>
<p>Ready to revolutionize your LLM development process? In this video, I'll unveil how you can effortlessly create a Sentiment Analysis, Entity Extraction &amp; Text Summarization Solution in mere minutes using the game-changing Gradient Accelerator Blocks! Say goodbye to the challenges and resource-intensive nature of LLM Solution development! With Gradient Accelerator Blocks, you'll dive into AI development with ease, thanks to their comprehensive and user-friendly building blocks.</p>
<h2>Click to open the Notebook directly in Google Colab</h2>
<!-- [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/bhattbhavesh91/sentiment-analysis-ner-gradient/blob/main/gradient-blocks-notebook.ipynb)
 -->

<p><a href="https://colab.research.google.com/github/bhattbhavesh91/sentiment-analysis-ner-gradient/blob/main/gradient-blocks-notebook.ipynb" target="_blank"><img height="40" alt="Open in Colab" src = "https://colab.research.google.com/assets/colab-badge.svg"></a></p>
<h2>To view the video</h2>
<table>
   <tr>
      <td><a href="http://www.youtube.com/watch?v=KnOfeHuNyTI" target="_blank"><img height="50" src = "https://img.shields.io/youtube/views/KnOfeHuNyTI?color=blue&label=Watch%20on%20YouTube&logo=youtube&logoColor=red&style=for-the-badge"></a></td>
   </tr>
</table>

<p>or click on the image below</p>
<p><a href="http://www.youtube.com/watch?v=KnOfeHuNyTI"><img alt="Gradient_Sentiment_Block_V1
" src="http://img.youtube.com/vi/KnOfeHuNyTI/0.jpg" /></a></p>
